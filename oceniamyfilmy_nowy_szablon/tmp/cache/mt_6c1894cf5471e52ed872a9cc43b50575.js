...
tinymce.init({
    ...
    cmsms_tiny: cmsms_tiny = {
        schema: 'html5',
        base_url: 'http://localhost/oceniamyfilmy/',
        resize: true,
        statusbar: true,
        menubar: true,
        filepicker_title: 'Wyb&oacute;r pliku',
        filepicker_url: 'http://localhost/oceniamyfilmy/admin/moduleinterface.php?mact=FilePicker,m1_,filepicker,0&__c=5757f20c91ee50f04e6&showtemplate=false&field=',
        filebrowser_title: 'Select a file',
        linker_text: 'Link to CMSMS Page',
        linker_title: 'Create a link to a CMSMS content page',
        linker_image: 'http://localhost/oceniamyfilmy/modules/MicroTiny/lib/images/cmsmslink.gif',
        linker_url: 'http://localhost/oceniamyfilmy/admin/moduleinterface.php?mact=MicroTiny,m1_,linker,0&__c=5757f20c91ee50f04e6&showtemplate=false',
        linker_autocomplete_url: 'http://localhost/oceniamyfilmy/admin/moduleinterface.php?mact=MicroTiny,m1_,ajax_getpages,0&__c=5757f20c91ee50f04e6&showtemplate=false',
        mailto_text: 'Create a mail link',
        mailto_title: 'Create a mail image',
        mailto_image: 'http://localhost/oceniamyfilmy/modules/MicroTiny/lib/images/mailto.gif',
